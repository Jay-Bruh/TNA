        ...
        <div className={styles.container}>
          <header className={styles.backToHome}>
            <div style={{ display: "flex", justifyContent: "space-between" }}>
              ...
              <a className={styles.urlNoDecoration} href={"/" + lang + "/post/" + roomName + "/" + screenName} style={{paddingLeft:"40px",paddingRight:"80px",paddingBottom:"40px"}}>
              ...
              &nbsp;
              <div className={lang.toUpperCase() == 'EN' ? styles.roundedCornersBox : styles.roundedCornersBoxAR} style={{marginTop:"20px",maxHeight:"50px"}}>
      ...
      <div>
        <div className={styles.container}>
          <header style={{marginTop:"2rem"}}>
            <div style={{ display: "flex", justifyContent: "space-between" }}>
              <div style={{backgroundColor:"white",color:"#007293",height:"4rem",fontSize:"2rem",padding:"0.5rem",borderRadius:"16px"}}>
                <a style={{textDecoration:"none",color:"#007293"}}href={englishUrl}>
                <span className="engname">English</span> 
                </a>
                | <span className="arname">العربية</span>
              </div>
            <div>
                <a href={"/" + lang + "/post/" + roomName + "/" + screenName}>
                  <img src={require("./../../nextjs/public/icons/HomeIcon.svg")} />
                </a>
              </div>
